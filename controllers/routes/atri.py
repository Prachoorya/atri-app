...
class Atri:
	def __init__(self, state: Any):
		...
		self.Div_navbar = state["Div_navbar"]
	...
	@property
	def Div_navbar(self):
		self._getter_access_tracker["Div_navbar"] = {}
		return self._Div_navbar
	@Div_navbar.setter
	def Div_navbar(self, new_state):
		self._setter_access_tracker["Div_navbar"] = {}
		global default_state
		self._Div_navbar = Div(new_state, default_state["Div_navbar"])
